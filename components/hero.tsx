...
export default function Hero({ onGetStarted }: HeroProps) {
  const [popupState, setPopupState] = useState<{
    type: "github" | "email" | "phone" | "facebook" | "instagram" | null
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-4">
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-12 h-12 rounded-full bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-pink-400 transition-all duration-300 shadow-lg hover:shadow-pink-400/50 hover:scale-110"
                >
                  <svg className="w-5 h-5 text-white drop-shadow-[0_0_8px_rgba(236,72,153,0.6)]" fill="currentColor" viewBox="0 0 24 24">
